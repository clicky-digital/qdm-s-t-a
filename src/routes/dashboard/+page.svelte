...
<div class="container mx-auto flex flex-col gap-6 my-4">
    <div class="ml-4 sm:ml-0 md:ml-4 md:mb-4 xl:ml-4 xl:mb-4 text-2xl font-bold text-slate-900">Continuar Assistindo</div>

    <div class="flex flex-col px-4 gap-14 xl:grid xl:grid-cols-3">

        {#await data['profile']}
            <p>Carregando Último Assistido...</p>
            {:then profile}
            <div class="col-span-2 h-96 lg:h-110 {!profile.keep_watching ? 'border-gray-200 border rounded-2xl' : ''} flex justify-center">
    ...
    <div class="flex p-14 lg:p-0 xl:p-14 gap-4">
